...
- For generating pages from `.mdx` files, I'm using Kent C Dodds' [mdx-bundler](https://weibo.com/kentcdodds/mdx-bundler). In combination with Next.js it makes generating pages from `.mdx` files really quick and simple.
